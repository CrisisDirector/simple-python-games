...
class Hand:
    ...
    def single_card(self, place): #implement error recovery routines here
        if place < 1:
            print("The card index must be a natural number") 
        elif place > len(self.cards):
        ...
        if turn == 'Player':
            ...
            if choice == 'h':
                ...
                try:
                    ...
                    print("Pick a card you actually have this time.....")                
            elif choice == 'p':
                temp_card = deck.deal()
